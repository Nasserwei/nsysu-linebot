...
def build_school_links_flex() -> FlexMessage:
    ...
    links = [
        ...
        ("🖥️", "網路大學",    "https://identity.nsysu.edu.tw/auth/realms/nsysu/protocol/cas/login?ui_locales=zh-TW&service=https%3A//elearn.nsysu.edu.tw/login%3Fnext%3D/user/index&locale=zh_TW"),
        ("📋", "資管系官網",  "https://web.mis.nsysu.edu.tw/"),
